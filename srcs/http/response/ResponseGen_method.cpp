...
ResponseGenerator::_method_get_dir(const RequestInfo &request_info,
  ...
  content_action_.action_  = ContentAction::USE_CONTENT;
  content_action_.content_ = create_autoindex_body(request_info, target_path);
...
ResponseGenerator::_method_get_file(const RequestInfo &request_info,
  ...
  if (has_suffix(target_path, ".py")) {
    ...
    content_action_.action_  = ContentAction::USE_CONTENT;
    content_action_.content_ = result.object_;
    return HttpStatusCode::S_200_OK;
  }
  ...
  content_action_.action_ = ContentAction::READ;
  content_action_.fd_     = result.object_;
  return HttpStatusCode::S_200_OK;
}
...
*/
  ...
  content_action_.action_  = ContentAction::WRITE;
  content_action_.fd_      = result.object_;
  content_action_.content_ = request_info.body_;
